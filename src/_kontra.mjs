 ...
 */
class KText extends GameObject {
  init({
    // --------------------------------------------------
    // defaults
    // --------------------------------------------------
 ...
 * @param {Object} [properties.text] - Properties of [KText](api/text) which are used to create the [textNode](api/button#textNode).
...
class Button extends Sprite {
  ...
  init({
    ...
    /**
     * Each Button creates a KText object and adds it as a child. The `text` of the KText object is used as the accessible name of the HTMLButtonElement.
     * @memberof Button
     * @property {KText} textNode
     */
  ...
  /**
   * The text property of the KText object.
   * @memberof Button
   * @property {String} text
   */
  get text() {
