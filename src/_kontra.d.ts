declare namespace kontra {
  ...
  function Animation(properties: {spriteSheet: SpriteSheet, frames: number[], frameRate: number, loop?: boolean}): Animation;
  ...
  interface TextConstructor {
    new(properties: {text: string, font?: string, color?: string, width?: number, textAlign?: string, lineHeight?: number, x?: number, y?: number, height?: number, context?: CanvasRenderingContext2D, dx?: number, dy?: number, ddx?: number, ddy?: number, ttl?: number, anchor?: {x: number, y: number}, children?: GameObject[], opacity?: number, rotation?: number, scaleX?: number, scaleY?: number, update?: (dt?: number) => void, render?: Function, [props: string]: any}): KText;
  }
  ...
  function onGamepad(buttons: string | string[], callback: (gamepad: Gamepad, button: GamepadButton) => void, options?: {gamepad?: number, handler?: 'gamepaddown' | 'gamepadup'}): void;
